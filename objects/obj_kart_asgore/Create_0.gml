...
kart_accel=0.185
kart_turn=6
final_sprite=spr_kasgore_d
mdlspr_right=spr_kasgore_r
mdlspr_left=spr_kasgore_l
mdlspr_down=spr_kasgore_d
mdlspr_up=spr_kasgore_u
mdlspr_stun=spr_kasgore_stun
mdlspr_victory=spr_kasgore_victory
