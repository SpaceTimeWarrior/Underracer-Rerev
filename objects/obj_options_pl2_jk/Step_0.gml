...
if image_index=0{if mouse_check_button_pressed(mb_any){global.control_pl2move_jk=gamepad_find_button(p2gp) sound_2play(snd_click) alarm[0]=3}}
if image_index=1{if mouse_check_button_pressed(mb_any){global.control_pl2break_jk=gamepad_find_button(p2gp) sound_2play(snd_click) alarm[0]=3}}
if image_index=2{if mouse_check_button_pressed(mb_any){global.control_pl2right_jk=gamepad_find_button(p2gp) sound_2play(snd_click) alarm[0]=3}}
if image_index=3{if mouse_check_button_pressed(mb_any){global.control_pl2left_jk=gamepad_find_button(p2gp) sound_2play(snd_click) alarm[0]=3}}
