...
kart_accel=0.2125
kart_turn=5.25
final_sprite=spr_kmttex_d
mdlspr_right=spr_kmttex_r
mdlspr_left=spr_kmttex_l
mdlspr_down=spr_kmttex_d
mdlspr_up=spr_kmttex_u
mdlspr_stun=spr_kmttex_stun
mdlspr_victory=spr_kmttex_victory
