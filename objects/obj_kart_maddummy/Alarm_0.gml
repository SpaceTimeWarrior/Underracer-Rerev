...
if skin="UnderFell Papyrus"{
final_sprite=spr_uf_papy_d
mdlspr_right=spr_uf_papy_r
mdlspr_left=spr_uf_papy_l
mdlspr_down=spr_uf_papy_d
mdlspr_up=spr_uf_papy_u
mdlspr_stun=spr_uf_papy_stun
...
if skin="Mad Mew Mew02"{
	...
	mdlspr_down=spr_mewmew_d_c
	mdlspr_up=spr_mewmew_u_c
	mdlspr_stun=spr_mewmew_stun_c
